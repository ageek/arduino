...
// In 4in1 module: shows time in 90deg right rotated + right to left time (sec - then min - then hr)
// individually the digits are displayed correctly(but 90 deg right rotted)
// TODO: fix above
// Note: doesnot use MD_Max72xx lib. contains custom max7219 lib
