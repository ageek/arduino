// For code details refer the below link:
//https://github.com/vlytsus/arduinosensor/blob/master/arduino_sensor_main.ino
/*  ***************************************************************
...
#define DISPLAY_REFRESH_INTERVAL 30    //def=30, code needs to be updated for other/lower values, else may show -ve values
