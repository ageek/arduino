...
// Note: when using headers etc, its throwing undefined reference errors, should be easy fix
// for now adding all the defs directly in this file - not recommended though
